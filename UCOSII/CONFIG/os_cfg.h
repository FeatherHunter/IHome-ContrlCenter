...
#define OS_MAX_EVENTS            30u   /*系统最大事件数 Max. number of event control blocks in your application      */
...
#define OS_TICKS_PER_SEC       	200u   /* 设置1s时间的节拍数 Set the number of ticks in one second                        */
